...
export default function EstadoActualCiclo({
  ...
  return (
    <section className="relative w-full h-[480px] sm:h-[520px] md:h-[580px] lg:h-[620px] xl:h-[680px] 2xl:h-[720px] max-h-[800px] rounded-3xl overflow-hidden shadow-2xl bg-pink-100 mx-auto">
      {data.imagen_url && (
        <Image
          src={data.imagen_url}
